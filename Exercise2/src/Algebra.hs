...
checkProgram2 pro = checkUndefinedRules && checkStartRule && 
    ...
    where
        ...
        checkPatternMatchFailure = True

        foldPattern :: TESTAlgebra Bool Bool Bool Bool Bool [Pat] Pat Pat
        foldPattern = ((p1),(r1),(cs1,cs2),(c1,c2,c3,c4),(d1),(as1,as2),(a1),(pt1,pt2,pt3,pt4,pt5,pt6))
            where
                ...
                c1 = True
                c2 dir = True
                c3 dir alts = (all (`elem` alts) contents || PUnderscore `elem` alts)
                c4 s = True
                d1 = True
                as1 = []
                as2 alt alts = alt : alts
                a1 pat cmds = pat
                pt1 = PEmpty
                pt2 = PLambda
                pt3 = PDebris
